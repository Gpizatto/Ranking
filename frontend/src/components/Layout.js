        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <nav className="flex flex-wrap gap-2 justify-center sm:justify-end">
              <Link
                to="/rankings"
                className={`px-3 py-2 text-sm sm:text-base rounded-lg ${isActive('rankings') ? 'bg-green-500 text-white' : 'text-gray-300 hover:bg-slate-800'}`}
              >
              ...
              <Link
                to="/tournaments"
                className={`px-3 py-2 text-sm sm:text-base rounded-lg ${isActive('tournaments') ? 'bg-green-500 text-white' : 'text-gray-300 hover:bg-slate-800'}`}
              >
              ...
              <Link
                to="/players"
                className={`px-3 py-2 text-sm sm:text-base rounded-lg ${isActive('players') ? 'bg-green-500 text-white' : 'text-gray-300 hover:bg-slate-800'}`}
              >
              ...
              {isAuth ? (
                <>
                  <Link
                    to="/admin"
                    className={`px-3 py-2 text-sm sm:text-base rounded-lg ${isAdminPage ? 'bg-blue-500 text-white' : 'text-gray-300 hover:bg-slate-800'}`}
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2 text-sm sm:text-base rounded-lg text-gray-300 hover:bg-red-500/20 hover:text-red-400"
                  >
                ...
                <Link
                  to="/login"
                  className="px-3 py-2 text-sm sm:text-base rounded-lg bg-blue-500 text-white hover:bg-blue-600"
                >
                  Login
                </Link>
              )}
